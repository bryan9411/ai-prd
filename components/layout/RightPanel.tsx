		...
		return moreActions.map((action) => {
			...
			return (
				<Button
					...
					className={cx(
						'w-full mb-4 justify-start gap-2 px-3 h-auto py-2.5 text-sm font-medium',
						action.danger
							? 'text-red-500 border-red-100 dark:border-red-950 hover:bg-red-50 dark:hover:bg-red-950/40 hover:text-red-500'
